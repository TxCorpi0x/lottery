...
export type BetMsgCreateBetResponse = object;

/**
 * Params defines the parameters for the module.
 */
export type BetParams = object;

export interface BetQueryAllBetResponse {
  bet?: BetBet[];
...
export interface BetQueryGetBetResponse {
  bet?: BetBet;
}
 ...
 */
export interface BetQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/vjdmhd/lottery/bet/params
   */
